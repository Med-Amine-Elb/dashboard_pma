...
**content** | [**Array&lt;CalendarEventDto&gt;**](CalendarEventDto.md) |  | [optional] [default to undefined]
...
```typescript
import { PageCalendarEventDto } from './api';

const instance: PageCalendarEventDto = {
    totalPages,
    totalElements,
    first,
    last,
